...
def saveNewProjectDetails(project_name, tag_set, text_data, tag_set_meta_data):
    ...
    userprojects.update_one({ 'username' : current_user.username }, \
        { '$set' : { 'myproject' : userprojectnamelist, 'activeproject' :  project_name}})
...
def updateProjectDetails(project_name, project_shared_with):
    ...
    userprojects.update_one({ 'username' : current_user.username }, \
        { '$set' : { 'myproject' : list(set(userprojectnamelist)), 'activeproject' :  project_name}})
...
@app.route('/textAnno', methods=['GET', 'POST'])
@login_required
def textAnno():
    projects = mongo.db.projects              # collection of users and their respective projects
    userprojects = mongo.db.userprojects              # collection of users and their respective projects
...
@app.route('/savetextAnno', methods=['GET', 'POST'])
@login_required
def savetextAnno():
    projects = mongo.db.projects              # collection of users and their respective projects
    userprojects = mongo.db.userprojects              # collection of users and their respective projects
...
@app.route('/loadprevioustext', methods=['GET'])
@login_required
...
@app.route('/loadnexttext', methods=['GET'])
@login_required
def loadnexttext():
    projects = mongo.db.projects              # collection of users and their respective projects
    userprojects = mongo.db.userprojects              # collection of users and their respective projects
...
@app.route('/imageAnno', methods=['GET', 'POST'])
@login_required
def imageAnno():
    # projects = mongo.db.projects              # collection of users and their respective projects
...
@app.route('/saveimageAnno', methods=['GET', 'POST'])
@login_required
def saveimageAnno():
    projects = mongo.db.projects              # collection of users and their respective projects
    userprojects = mongo.db.userprojects              # collection of users and their respective projects
...
@app.route('/loadpreviousimage', methods=['GET'])
@login_required
...
@app.route('/loadnextimage', methods=['GET'])
@login_required
def loadnextimage():
    projects = mongo.db.projects              # collection of users and their respective projects
    userprojects = mongo.db.userprojects              # collection of users and their respective projects
...
def dummyUserandProject():
    ...
    if len(mongo.db.list_collection_names()) == 0:
        userprojects.insert_one({'username' : "dummyUser", 'myproject': ["dummyProject"], \
            'projectsharedwithme': [], 'activeproject' : "dummyProject"})
...
@app.route('/downloadannotationfile', methods=['GET', 'POST'])
...
@app.route('/downloadallannotationfiles', methods=['GET', 'POST'])
...
@app.route('/downloadallusersallannotationfiles', methods=['GET', 'POST'])
...
@app.route('/downloadoneuserallannotatedfiles/<username>')
